...
/// OpenGL deck surface: composites two A/B MediaSources through a Transition plus
/// an overlay chain, and exposes the composited result as a ProgramFrameSource
/// for the program output (preview/record/NDI).
